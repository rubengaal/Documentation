...
\begin{document}	
    ...
    \section{Eredmények}
        ...
        \subsection{Arcrekonstrukció}
            ...
            \begin{figure}[htb]
                \centering
                \includegraphics[width=.3\textwidth]{pique_3d.jpg}\hfill
                \includegraphics[width=.3\textwidth]{hua_3d.jpg}\hfill
                \includegraphics[width=.3\textwidth]{ruben_3d.jpg}
            ...
            \begin{figure}[h]	
                ...
                \caption{A FOCUS model eredményei. (Fentről lefelé: bemeneti
